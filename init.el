...
(custom-set-variables
 ...
 '(package-selected-packages
   (quote
	(yasnippet use-package modern-cpp-font-lock markdown-mode google-c-style flycheck fill-column-indicator counsel-etags color-theme-sanityinc-tomorrow clang-format autopair))))
(custom-set-faces
